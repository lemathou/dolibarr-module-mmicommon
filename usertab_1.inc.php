 ...
 * Copyright (C) 2022-2025 Mathieu Moulin       <mathieu@iprospective.fr>
 *
...
$contextpage = GETPOST('contextpage', 'aZ') ?GETPOST('contextpage', 'aZ') : $tab_ref; // To manage different context of search
 ...
 */
 ...
 if (file_exists('actions/'.$tab_name.'.inc.php'))
	require_once 'actions/'.$tab_name.'.inc.php';
 ...
 */
 ...
 if ($id) {
	 ...
	 print dol_get_fiche_head($head, $tab_ref, $title, -1, 'user');
	 ...
	 require_once 'tpl/'.$tab_name.'.tpl.php';
