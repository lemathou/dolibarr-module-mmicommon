...
function MMIAdminPrepareHead()
{
	...
	$head[$h][0] = dol_buildpath("/".$moduledir."/admin/setup.php", 1);
	...
	*/
	...
	$head[$h][0] = dol_buildpath("/".$moduledir."/admin/about.php", 1);
	...
	//	'entity:-tabname:Title:@mmiproject:/mmiproject/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, null, $head, $h, $modulecontext);

	//complete_head_from_modules($conf, $langs, $object, $head, $h, $modulecontext, 'remove');
